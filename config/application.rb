...
module KentonBoutwell
  class Application < Rails::Application
    ...
    config.assets.precompile += %w(bootstrap.min.js jquery-ba-cond.min.js jquery-slitslider.js main.js twitter-bootstrap-hover-dropdown.min.js)
